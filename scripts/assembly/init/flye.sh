...
cp /proj/uppmax2025-3-3/nobackup/work/melvi/data/processed_reads/DNA_long_reads/SRR24413066/SRR24413066.correctedReads.fasta.gz ./corrected.fasta.gz
...
# Copy output back
cp -r canu_corrected_out /proj/uppmax2025-3-3/nobackup/work/melvi/assembly/canu_assembly/SRR24413066

# Copy corrected reads and decompress them
cp /proj/uppmax2025-3-3/nobackup/work/melvi/data/processed_reads/DNA_long_reads/SRR24413072/SRR24413072.correctedReads.fasta.gz ./corrected.fasta.gz
gunzip corrected.fasta.gz  # decompress to corrected.fasta
...
# Copy output back
cp -r canu_corrected_out /proj/uppmax2025-3-3/nobackup/work/melvi/assembly/canu_assembly/SRR24413072
